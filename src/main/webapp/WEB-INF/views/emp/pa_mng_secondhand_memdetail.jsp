...
<form id="frm" method="get" enctype="multipart/form-data">
	<div class="intro-y news p-5 box mt-0">
		...
		<div class="intro-y flex relative pt-10 items-center pb-2">
		    <div class="absolute sm:relative w-full flex text-lg">
		        <div class="intro-x mr-3 font-medium">작성자 : ${detailOne.frstWrterId}<span class="font-medium"></span> </div>
		    </div>
		    <div class="absolute sm:relative -mt-12 sm:mt-0 w-full flex justify-end">
		    	<!-- ////// 삭제 버튼  ///////-->
			    <button type="button" id="btnDelete" class="btn btn-outline-primary font-bold text-base py-1.5" value="${detailOne.pstId}">삭제</button>
				<!-- ////// 삭제 버튼  ///////-->
		    </div>
		</div>
		<div class="intro-y flex text-lg m flex-col sm:flex-row items-center pt-5 border-t border-slate-200/60">
			<div class="flex items-center">
				<div class="mr-auto">
					<h6 class="font-medium">판매가 :<fmt:formatNumber value='${detailOne.scndhandPc}' type="number"/>원</h6>
				</div>
			</div>
			<div class="flex items-center ml-auto mr-5">
				<h6 class="font-medium leading-none">조회수 : ${detailOne.rdcnt}</h6>
			</div>
			<div class="flex items-center">
				<h6 class="font-medium leading-none">작성일 : ${detailOne.fsrtWritingTm}</h6>
			</div>
		</div>
		...
		<div class="intro-y mt-2 pt-5 border-t border-slate-200/60 dark:border-darkmode-400">
		    <div class="flex justify-between items-center">
		        <div class="text-lg font-medium">댓글수 0</div>
		        <div class="text-base">
		            <a href="/emp/pa/mngscndhandbbs" class="btn btn-primary py-1.5">목록</a>
		        </div>
		    </div>
