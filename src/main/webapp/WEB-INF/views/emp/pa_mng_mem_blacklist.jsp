...
<div class="bdy col-span-12 lg:col-span-9 2xl:col-span-10">
	<div class="intro-y flex flex-col sm:flex-row items-center mt-0">
		<h5 class="text-lg font-medium leading-none mt-0 mr-auto">계정 관리 > 입주민계정 관리 > 블랙리스트 </h5>
    ...
    <div class="modal-dialog" >
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h2 class="font-bold text-lg mr-auto">신고 내역</h2>
            ...
            <div class="modal-body grid grid-cols-6 gap-4 gap-y-3" style="margin-left: 1px; margin-right: 1px;">
				<div class="col-span-6 sm:col-span-6">
				     <table id="mytable" class="table table-sm text-center font-bold">
				         <thead>
				         	<tr>
				         		<th class="whitespace-nowrap text-base">게시물ID</th>
				                <th class="whitespace-nowrap text-base">신고내용</th>
				                <th class="whitespace-nowrap text-base">신고자</th>
				            </tr>
				         </thead>
				         <tbody id="mytbody">
				         </tbody>
            ...
            <!-- BEGIN: Modal Footer -->
            <div class="modal-footer"> <button id="sttemntBtn" type="button" data-tw-dismiss="modal"><span class="btn btn-primary w-20 mr-1">확인</span></button></div> <!-- END: Modal Footer -->
        </div>
    </div>
</div>
     ...
     <div class="modal-dialog" >
         <div class="modal-content">
             ...
             <div class="modal-body grid grid-cols-6 gap-4 gap-y-3" style="margin-left: 130px; margin-right: 100px;">
                 <div class="col-span-6 sm:col-span-6"> <label for="modal-form-1" class="form-label ml-1" style="white-space: nowrap;">블랙리스트 해제 하시겠습니까?</label></div>
             </div>
             <!-- BEGIN: Modal Footer -->
...
$(function(){
	if ($("#test").length) {
	    ...
	    var table = new Tabulator("#test", {
			...
			ajaxURL: "/emp/pa/mngmemacnt/blacklist/load",
			ajaxFiltering: false,
			ajaxSorting: false,
			printAsHtml: true,
			printStyled: true,
			    	...
			    	$(icons).find(".mod").on("click", function() {
		    			...
		    			jQuery.ajax({
		    		        ...
		    		        success: function(result) {
		    		        	  ...
		    		        	  console.log("result[0].sttemntId : " + result[0].sttemntId);
		    		        	  let str = '';
			    ...
			    formatter: function(cell, formatterParams) {
			    	...
			    	$(icons).find(".approval").on("click", function() {
						...
						$("#approvalModalBtn").on("click", function() {
			    			...
			    			console.log(data);
			    			jQuery.ajax({
			    		        url: '/emp/pa/mngmemacnt/blacklist/clear',
			    		        contentType : "application/json;charset=utf-8",
			    		        type: 'post',
			    		        data: JSON.stringify(data),
			    		        dataType : "json",
