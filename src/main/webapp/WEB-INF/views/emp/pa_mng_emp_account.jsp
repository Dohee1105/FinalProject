...
<div class="bdy col-span-12 lg:col-span-9 2xl:col-span-10">
	<div class="intro-y flex items-center">
		<h5 class="text-lg font-medium leading-none mr-auto">인사/행정 > 계정 관리	> 직원계정 관리</h5>
		<div class="w-full sm:w-auto flex mt-4 sm:mt-0">
			<button class="btn btn-primary text-base py-1.5 shadow-md" onclick="location.href='/emp/pa/mngempacnt/register'">직원 등록</button>
		</div>
	</div>
