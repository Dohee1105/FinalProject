	...
	<div class="intro-y box bg-primary p-4 mt-0 text-lg">
		<nav class="side-nav">
			<ul>
				...
				<li><a href="/emp/onair/resveannnc" class="side-menu">
						<div class="side-menu__icon">
							<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
								viewBox="0 0 24 24" fill="none" stroke="currentColor"
								stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
...
<div class="bdy col-span-10 lg:col-span-9 2xl:col-span-10">
	<div class="flex" style="justify-content: space-between;">
		...
		<a href="/emp/onair/annnc/register" class="btn btn-primary"
			style="background-color: #304993;">방송 등록</a>
	</div>
		...
		<form id="tabulator-html-filter-form" class="xl:flex sm:mr-auto">
			<div class="sm:flex items-center sm:mr-4">
				<select name="cond" id="cond" aria-controls="dataTable"
					...
					<option value="" disabled="" selected="" hidden="">방송 검색</option>
			...
			<div class="sm:flex items-center sm:mr-4 mt-2 xl:mt-0">
				<input id="keyword" type="text" name="keyword" type="text"
					...
					placeholder="검색어를 입력해주세요" aria-controls="dataTable"
					value="${param.keyword}" />
			</div>
			...
			<div id="test" class="table-report table-report--tabulator tabulator"
				...
				<div class="tabulator-header"
					...
					<div class="tabulator-headers" style="margin-left: 0px;">
						...
						<div class="tabulator-col tabulator-sortable" role="columnheader"
							...
							style="min-width: 420px; width: 0px; height: 44px;">
							<div class="tabulator-col-content">
								<div class="tabulator-col-title-holder">
				...
				<div class="tabulator-tableHolder" tabindex="0"
					...
					<div class="tabulator-table"
						...
						<c:forEach var="data" items="${data.content}" varStatus="stat">
							<div class="tabulator-row tabulator-selectable tabulator-row-odd"
								role="row" style="padding-left: 0px;">
								<div id="annncNo" class="tabulator-cell" role="gridcell"
									tabulator-field="seq" title=""
								...
								<div class="tabulator-cell text-left" role="gridcell"
									...
									style="width: 120px; text-align: left; display: inline-flex; align-items: center; justify-content: flex-center; height: 44px;">
									${data.frstWrterId}
									<div class="tabulator-col-resize-handle"></div>
									<div class="tabulator-col-resize-handle prev"></div>
								</div>
								...
								<div class="tabulator-cell" role="gridcell"
									tabulator-field="content" title=""
									style="width: 410px; text-align: center; display: inline-flex; align-items: center; justify-content: center; height: 44px;">
									${data.annncCn}
									<div class="tabulator-col-resize-handle"></div>
									<div class="tabulator-col-resize-handle prev"></div>
								</div>
								<div class="tabulator-cell btnDelete" role="gridcell"
									tabulator-field="date" title=""
									style="width: 170px; text-align: center; display: inline-flex; align-items: center; justify-content: center; height: 44px;">
									<svg class="text-danger" xmlns="http://www.w3.org/2000/svg"
										width="19" height="19" viewBox="0 0 24 24" fill="none"
										stroke="currentColor" stroke-width="2" stroke-linecap="round"
										stroke-linejoin="round" icon-name="trash-2"
										data-lucide="trash-2"
										class="lucide lucide-trash-2 block mx-auto">
					...
					<nav class="w-full sm:w-auto sm:mr-auto">
						<ul class="pagination">
							<li class="page-item"><a class="page-link"
								href="/emp/onair/annnc?currentPage=1"> <svg
							...
							<li class="page-item"><a class="page-link"
								<c:if test="${data.startPage>=3}">
									href="/emp/onair/annnc?cond=${param.cond}&keyword=${param.keyword }&size=${param.size}&currentPage=${data.startPage-3}"
								</c:if>
							...
							<c:forEach var="pNo" begin="${data.startPage}"
								end="${data.endPage}" step="1">
								<li class="page-item"><a class="page-link"
									href="/emp/onair/annnc?cond=${param.cond}&keyword=${param.keyword }&size=${param.size}&currentPage=${pNo}">${pNo}</a>
								</li>
							</c:forEach>
							<li class="page-item"><a class="page-link"
							...
							<li class="page-item"><a class="page-link"
								href="/emp/onair/annnc?cond=${param.cond}&keyword=${param.keyword }&size=${param.size}&currentPage=${data.totalPages}">
									<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
										viewBox="0 0 24 24" fill="none" stroke="currentColor"
										stroke-width="2" stroke-linecap="round"
...
<script type="text/javascript">
	$(function() {
		...
		$(".btnDelete").on(
				"click",
				function() {
					let annncNo = $(this).closest(".tabulator-row").find(
							"#annncNo").text().trim();
					// json 오브젝트
					let data = {
						"annncNo" : annncNo
					...
					if (confirm("삭제하시겠습니까?")) {
						jQuery.ajax({
							url : "/emp/onair/annnc/deletePost",
