...
<h5 class="text-lg font-medium leading-none mt-3">시설/보안 > 공용시설 관리 > 독서실</h5>
...
<!-- 시설 유의사항 -->
<div class="intro-y box" style="width: 980px; height: 430px; margin-top: 20px;">
    <div class="" style="float: left; width:850px;">
        ...
        <textarea class="borderless" style="border: none; font-size: 20px; line-height: 1.5; width: 820px; height: 350px;" readonly>
           ◆ 운영시간
              - 평일 : 오전 09시 ~ 오후 23시
              - 토요일 : 오전 9시 ~ 오후 18시
              - 공휴일 및 일요일 휴무
