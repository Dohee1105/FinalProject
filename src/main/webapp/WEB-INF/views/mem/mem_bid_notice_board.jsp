...
<div class="bdy col-span-10">
	<div class="alert alert-dismissible show box bg-primary text-white flex items-center font-semibold" role="alert">
    	<span style="font-size: 20px; margin-left:20px;">입찰공고</span>
	</div>
