...
/**
 * @Class Name : MngElectricityInsepectionController.java
 * @Description : MngElectricityInsepectionController Class
...
@Controller
public class MngElectricityInsepectionController {
